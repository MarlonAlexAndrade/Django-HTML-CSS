...
class RecipeModelTest(RecipeTestBase):
    ...
    def make_recipe_no_default(self):
        recipe = Recipe(
            category_data=self.make_category(name='Tesst Default Category'),
    ...
    def teste_recipe_fields_max_length(self, field, max_length):
    ...
    def test_recipe_published_steps_false_by_default(self):
        recipe = self.make_recipe_no_default()
        self.assertFalse(recipe.preparation_steps_is_html, 
